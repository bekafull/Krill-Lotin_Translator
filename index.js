...
const lotinArr = ["q", "w", "e", "r", "t", "y", "u", "i", "o", "p", "a", "s", "d", "f", "g", "h", "j", "k", "l", "z", "x", "ch", "c", "v", "b", "n", "m", "sh", "'", "ya"];
const krillArr = ["к", "w", "е", "р", "т", "й", "у", "и", "о", "п", "а", "с", "д", "ф", "г", "х", "ж", "к", "л", "з", "х", "ч", "к", "в", "б", "н", "м", "ш", "", "я"];
let inputValue = "";
let isChanged = false;
...
shareBtn.addEventListener("click", () => {
    const shareData = {
        ...
        text: "Translate your texts from Latin to Krill or from Krill to Latin with one click!",
        url: "https://translator-beknur.netlify.app"
    };
